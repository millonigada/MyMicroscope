...
import 'package:my_camera/screens/analyzeScreen.dart';
...
class MicroworldScreen extends StatefulWidget {

  @override
  _MicroworldScreenState createState() => _MicroworldScreenState();
}

class _MicroworldScreenState extends State<MicroworldScreen> with TickerProviderStateMixin{
    ...
    try{
      ...
      await cameraController.takePicture().then((XFile file){
        if(mounted) {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context){
            return AnalyzeScreen(imgFile: imgFile, imgPath: imgPath);
          }));
